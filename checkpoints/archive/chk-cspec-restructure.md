...
All goals achieved:
- ✓ Restructured project with permanent/ephemeral separation (`874669f`)
- ✓ Cleaned stale artifacts (`cc4dc20`)
- ✓ Added GitHub issue templates and slash commands (`809799a`)
- ✓ Flattened tooling structure and added templates CLI (`4b7225c`)

Next actions from checkpoint also completed:
- ✓ Slash commands created: `/cspec:issue-create`, `/cspec:issue-start`, `/cspec:proposal-write`, `/cspec:spec-write`, `/cspec:plan-write`, `/cspec:work-complete`
- ✓ Templates CLI added: `cspec templates list`, `cspec templates get`

## User Rules

- Never commit without explicit user approval
- No time estimates in plans
- Use GitHub Issues for tracking, not markdown TODOs
